...
public class apointments_users_confirmed_adapter extends FirestoreRecyclerAdapter<apointments_model, apointments_users_confirmed_adapter.holder> {


    public apointments_users_confirmed_adapter(@NonNull FirestoreRecyclerOptions<apointments_model> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull apointments_users_confirmed_adapter.holder holder, int i, @NonNull apointments_model model) {
        holder.bind(model);
    }

    @NonNull
    @Override
    public apointments_users_confirmed_adapter.holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_appointments_general, parent, false);

        return new apointments_users_confirmed_adapter.holder(view);
    }
